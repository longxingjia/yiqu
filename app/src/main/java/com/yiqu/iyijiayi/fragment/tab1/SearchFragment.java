        ...
        switch (id){
            case "searchMusic":
                if (type==TYPE_SUCCESS){
                    ArrayList<Music> musics= new Gson().fromJson(netResponse.data,(Type) new TypeToken<ArrayList<Music>>() {}.getType());
            ...
            case "searchUser":
                if (type==TYPE_SUCCESS){
                    ArrayList<UserInfo> user= new Gson().fromJson(netResponse.data,(Type) new TypeToken<ArrayList<UserInfo>>() {}.getType());
            ...
            case "searchByMusicName":
                ...
                if (type==TYPE_SUCCESS){
                    ArrayList<Sound> sound1= new Gson().fromJson(netResponse.data,(Type) new TypeToken<ArrayList<Sound>>() {}.getType());
