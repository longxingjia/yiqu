...
public class SoundTab1Fragment extends AbsFragment implements LoadMoreView.OnMoreListener, RefreshList.IRefreshListViewListener, NetCallBack {

    private ImageLoaderHm<ImageView> mImageLoaderHm;
    private LoadMoreView mLoadMoreView;
    private int count = 0;
    private int rows = 10;
    private String tag = "SoundTab1Fragment";
    //刷新
...
//
        ...
        RestNetCallHelper.callNet(getActivity(),
                ...
                "getMusicList", SoundTab1Fragment.this);
        ...
        if (mLoadMoreView.getMoreAble()) {
            if (mLoadMoreView.isloading()) {
                ...
                RestNetCallHelper.callNet(getActivity(),
                        MyNetApiConfig.getMusicList, MyNetRequestConfig
                                .getMusicList(getActivity(), count, rows),
                        "getMusicList_more", SoundTab1Fragment.this);
            }
        }
        return false;
    }
