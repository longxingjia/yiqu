...
public class Tab1Fragmentbak extends TabContentFragment implements LoadMoreView.OnMoreListener, OnClickListener, RefreshList.IRefreshListViewListener {

    private static final int TAB_1 = 1;
    private static final String tag = Tab1Fragmentbak.class.getSimpleName();
    //	List<>
        ...
        if (mPlayService != null && mPlayService.isPlaying()) {
            ...
            if (sid > 0) {
                RestNetCallHelper.callNet(getActivity(),
                        ...
                        "getSoundDetail", Tab1Fragmentbak.this);
...
//        nsDictionary.isreply = "1";
        ...
        RestNetCallHelper.callNet(
                ...
                "getBannerList", Tab1Fragmentbak.this, false, true);
...
//        setTitleBtnImg(R.mipmap.edit_tab);
    ...
    public void onRefresh() {
        ...
        RestNetCallHelper.callNet(
                ...
                "getSoundList", Tab1Fragmentbak.this);
        ...
        if (mLoadMoreView.getMoreAble()) {
            if (mLoadMoreView.isloading()) {
                ...
                RestNetCallHelper.callNet(
                        ...
                        MyNetApiConfig.getSoundList,
                        MyNetRequestConfig.getSoundList(getActivity(), arr, count, rows, "created", "asc", uid),
                        "getSoundList_more", Tab1Fragmentbak.this, false, true);
