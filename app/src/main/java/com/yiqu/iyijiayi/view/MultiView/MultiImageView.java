...
import com.yiqu.iyijiayi.view.ColorFilterImageView;
...
//            int expectH = photoInfo.h;
    ...
    //    L.e( MyNetApiConfig.ImageServerAddr+photoInfo);
        Glide.with(getContext()).load( MyNetApiConfig.ImageServerAddr+photoInfo).diskCacheStrategy(DiskCacheStrategy.ALL).into(imageView);
