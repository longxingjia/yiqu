...
import com.yiqu.iyijiayi.view.MultiView.spannable.SpannableClickable;
...
public class CommentListView extends LinearLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            //textview的默认颜色
            itemColor = typedArray.getColor(R.styleable.PraiseListView_item_color, getResources().getColor(R.color.normal_text_color));
            itemSelectorColor = typedArray.getColor(R.styleable.PraiseListView_item_selector_color, getResources().getColor(R.color.line_top_title));
    ...
    private SpannableString setClickableSpan(final String textStr, final String id) {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor){
                                    ...
                                    public void onClick(View widget) {
                                        Toast.makeText(CommonApplication.getInstance(), textStr + " &id = " + id, Toast.LENGTH_SHORT).show();
                                    }
