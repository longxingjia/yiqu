...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.line_top_title;
    /**整个textView的背景色*/
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = CommonApplication.getInstance().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = CommonApplication.getInstance().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
