...
public class LrcView extends View implements ILrcView {
     ...
     **/
    private int mSeekLineColor = Color.TRANSPARENT;
    /**
     * 拖动歌词时，展示当前高亮歌词的时间的字体颜色
     **/
    private int mSeekLineTextColor = Color.TRANSPARENT;
    /**
     ...
     * 歌词字体大小默认值
     **/
    private int mLrcFontSize = 28;    // font size of lrc
    /**
     * 歌词字体大小最小值
     **/
     ...
     * 当没有歌词的时候展示的内容
     **/
    private String mLoadingLrcTip = "歌词下载中...";
    ...
    public LrcView(Context context, AttributeSet attr) {
        ...
        mLrcFontSize =DensityUtil.dip2px(context,14);
        mSeekLineTextSize =DensityUtil.dip2px(context,14);
        mMinSeekLineTextSize =DensityUtil.dip2px(context,14);
        mMinLrcFontSize =DensityUtil.dip2px(context,14);
        mMaxSeekLineTextSize =DensityUtil.dip2px(context,18);
        mMaxLrcFontSize =DensityUtil.dip2px(context,18);
        mMinLrcFontSize =DensityUtil.dip2px(context,13);
